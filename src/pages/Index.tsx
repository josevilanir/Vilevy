...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-violet-100 p-2 sm:p-4">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              {uploadingFiles.map(file => (
                <div key={file.preview} className="border p-4 rounded bg-purple-50">
                  <img src={file.preview} alt="preview" className="w-full mb-2 rounded max-h-48 object-cover" />
                  <input
                    type="text"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Dialog open={selectedImage !== null} onOpenChange={() => setSelectedImage(null)}>
          <DialogContent className="bg-purple-50 border-4 border-purple-300 max-w-[95vw] max-h-[95vh] w-auto h-auto overflow-auto">
            {selectedImage && (
